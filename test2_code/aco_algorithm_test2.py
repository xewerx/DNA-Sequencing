...
from generator import create_errors, generate_dna_sequence, generate_subsequences, read_sequence_from_file, save_sequence_to_file, save_subsequences_to_file
...
if __name__ == "__main__":
    ...
    for i in range(20):
        for errors_percentage_i, errors_percentage in enumerate(errors_percentages):
            ...
            original_dna = read_sequence_from_file(f'test2_data/no_errors/dna_{i}.txt')[0]
            ...
            nodes, paths = read_file(f'test2_data/{errors_percentage}_errors/sequences_{i}.txt')
            ...
            with open(f'test2_data/{errors_percentage}_errors_output/output_{i}.txt', "w") as f:
